...
const DATABASE_ID = process.env.HELLO_CHANNELS_DATABASE_ID || process.env.DATABASE_ID;
const TABLE_ID = process.env.HELLO_CHANNELS_TABLE_ID || process.env.TABLE_ID;
